...
pub fn builtin_catalog() -> Vec<ScriptEntry> {
    ...
    vec![
        ...
        s("mcp.list_imports", "MCP · Program", "Enumerate imported symbols."),
        s("mcp.list_exports", "MCP · Program", "Enumerate exported symbols."),
        s("mcp.list_data_items", "MCP · Program", "Enumerate defined data items."),
        s("mcp.list_strings", "MCP · Program", "Enumerate recovered strings."),
        s("mcp.get_xrefs_to", "MCP · Xrefs", "References targeting a VA."),

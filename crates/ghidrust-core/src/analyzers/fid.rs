...
fn corpus() -> Vec<([u8; 8], &'static str)> {
    vec![
        ([0x55, 0x48, 0x89, 0xE5, 0x31, 0xC0, 0x5D, 0xC3], "fid_prolog_xor_ret"),
        ([0x55, 0x48, 0x89, 0xE5, 0x48, 0x83, 0xEC, 0x20], "fid_frame_sub20"),
        ([0x48, 0x83, 0xEC, 0x28, 0xFF, 0x15, 0x00, 0x00], "fid_sub28_call"),
    ]
}
